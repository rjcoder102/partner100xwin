...
import { getDipositeData, getDownlineUsers, getUserProfile, getwithdrawlData, loginUser, logoutUser, registerUser, resendOtp, updateDealyShare, updateUserLevels, verifyOtp } from '../controller/userController.js';
...
router.post("/update-leve", authMiddleware, updateUserLevels);
